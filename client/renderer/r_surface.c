...
static qboolean	LM_AllocBlock (int32_t w, int32_t h, int32_t *x, int32_t *y);

extern void R_SetCacheState( msurface_t *surf );
extern void R_BuildLightMap (msurface_t *surf, byte *dest, int32_t stride);
...
===============
*/
void R_SetLightingMode (int32_t renderflags)
{
	GL_SelectTexture (0);
...
================
*/
float SurfAlphaCalc (int32_t flags)
{
...
================
*/
qboolean R_SurfIsDynamic (msurface_t *surf, int32_t *mapNum)
{
	int32_t			map;
...
static void RB_DrawCaustics (msurface_t *surf)
{
	...
	dstscroll = -1.0 * ( (r_newrefdef.time*0.15) - (int32_t)(r_newrefdef.time*0.15) );
...
=================
*/
void R_DrawInlineBModel (entity_t *e, int32_t causticflag)
{
	int32_t			i, k;
	cplane_t	*pplane;
	float		dot;
...
void R_DrawBrushModel (entity_t *e)
{
	...
	int32_t			i, contents[9], contentsAND, contentsOR, causticflag = 0;
...
void R_DrawWorld (void)
{
	...
	ent.frame = r_worldframe = (int32_t)(r_newrefdef.time*2); 
	currententity = &ent;
