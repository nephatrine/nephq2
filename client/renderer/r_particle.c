...
===============
*/
void R_CheckParticleRenderState (particleRenderState_t *check, int32_t numVerts, int32_t numIndex)
{
...
===============
*/
int32_t TexParticle (int32_t type)
{	
...
void R_RenderDecal (particle_t *p)
{
	...
	vec4_t	partColor;
	int32_t		i, j, numVerts, numIndex;
	int32_t		mask, aggregatemask = ~0;			
